"""RapidAPI publishing automation for _craigslist_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Craigslist Jobs"
SHORT_DESC       = "Craigslist job postings with title, pay, posted date, and location."
LONG_DESC        = """Job listings scraped from Craigslist across US & Canadian cities. Records include title, hourly pay, posted date, full description text, listing URL, image when available, and geo-location tags captured at crawl time."""
COLLECTION_PATH  = "/v1/collections/_craigslist_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_craigslist_jobs/search
