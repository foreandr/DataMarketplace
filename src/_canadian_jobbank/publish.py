"""RapidAPI publishing automation for _canadian_jobbank."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Canadian Jobbank"
SHORT_DESC       = "Job postings from the Government of Canada Job Bank."
LONG_DESC        = """Job listings scraped from the Canadian Job Bank. Records include job title, 
...
COLLECTION_PATH  = "/v1/collections/_canadian_jobbank/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_canadian_jobbank/search
