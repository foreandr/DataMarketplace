"""RapidAPI publishing automation for _saskjobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Saskjobs"
SHORT_DESC       = "Job postings scraped from SaskJobs."
LONG_DESC        = """SaskJobs listings scraped from the SaskJobs results page. Records include job title, company, location, NOC code, post date, and listing identifiers."""
COLLECTION_PATH  = "/v1/collections/_saskjobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_saskjobs/search
