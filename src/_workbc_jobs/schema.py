...
SCHEMA = Schema(
    ...
    fields=[
        ...
        Field("title", "TEXT"),
        Field("company", "TEXT"),
        Field("location_raw", "TEXT"),
        Field("work_mode", "TEXT", indexed=True),
        Field("salary_raw", "TEXT"),
        Field("job_type", "TEXT", indexed=True),
        Field("job_number", "TEXT", indexed=True),
        Field("views", "INTEGER", indexed=True),
        Field("posted_date", "TEXT", indexed=True),
        Field("updated_date", "TEXT"),
        Field("expires_date", "TEXT", indexed=True),
        Field("url", "TEXT", unique=True, indexed=True),
        Field("city", "TEXT", indexed=True),
        Field("province", "TEXT", indexed=True),
