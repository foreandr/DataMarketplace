"""RapidAPI publishing automation for _workbc_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Workbc Jobs"
SHORT_DESC       = "Job postings scraped from WorkBC."
LONG_DESC        = """WorkBC job listings scraped from the WorkBC results page. Records include job title, company, location, salary range, job type, posting metadata (posted/updated/expires), and listing identifiers."""
COLLECTION_PATH  = "/v1/collections/_workbc_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_workbc_jobs/search
