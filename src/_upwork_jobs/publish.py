"""RapidAPI publishing automation for _upwork_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Upwork Jobs"
SHORT_DESC       = "Upwork job feed cards (title, budget, client details, and tags)."
LONG_DESC        = """Upwork job cards scraped from the search results feed. Records include post age, title, rate/budget details, experience level, description snippet, skills/tags, client verification, client rating/spend, client location, and proposal counts."""
COLLECTION_PATH  = "/v1/collections/_upwork_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_upwork_jobs/search
