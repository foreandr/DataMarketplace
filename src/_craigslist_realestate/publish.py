"""RapidAPI publishing automation for _craigslist_realestate."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Craigslist Realestate"
SHORT_DESC       = "Craigslist real estate listings with price, beds, baths, and location."
LONG_DESC        = """Real estate listings scraped from Craigslist across US & Canadian cities. Records include pricing, bedrooms, bathrooms, square footage when available, listing URL, image, and geo-location data tagged at crawl time. Bedrooms and square footage can be missing for some listings."""
COLLECTION_PATH  = "/v1/collections/_craigslist_realestate/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_craigslist_realestate/search
