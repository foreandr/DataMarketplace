"""RapidAPI publishing automation for _jobspider_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Jobspider Jobs"
SHORT_DESC       = "Job postings scraped from JobSpider."
LONG_DESC        = """JobSpider listings scraped from the results page. Records include job title, company, location, category, posted date, and sponsored flag."""
COLLECTION_PATH  = "/v1/collections/_jobspider_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_jobspider_jobs/search
