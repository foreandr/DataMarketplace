"""RapidAPI publishing automation for _goodwork_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Goodwork Jobs"
SHORT_DESC       = "Job postings scraped from GoodWork."
LONG_DESC        = """GoodWork listings scraped from the results page. Records include job title, organization, location, work mode, and job type."""
COLLECTION_PATH  = "/v1/collections/_goodwork_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_goodwork_jobs/search
