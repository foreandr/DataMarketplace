"""RapidAPI publishing automation for _indeed_jobs."""
...
LONG_DESC        = """Job listings scraped from Indeed. Records include job title, company name, location, raw pay string, normalized min/max hourly rate, employment type, schedule tags, benefits, and whether Easy Apply is available."""
COLLECTION_PATH  = "/v1/collections/_indeed_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_indeed_jobs/search
