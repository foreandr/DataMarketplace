"""RapidAPI publishing automation for _charityvillage_jobs."""
...
# ── Crawler metadata ─────────────────────────────────────────────────────────
DISPLAY_NAME     = "Charityvillage Jobs"
SHORT_DESC       = "Job postings scraped from CharityVillage."
LONG_DESC        = """CharityVillage listings scraped from the results page. Records include job title, organization, location, work mode, job type, salary, posted/expiry dates, and quick-apply availability."""
COLLECTION_PATH  = "/v1/collections/_charityvillage_jobs/search"
...
def uploading_new_process(browser) -> None:
    ...
    def create_rest_endpoint():
        ...
        # TODO: set path = /v1/collections/_charityvillage_jobs/search
